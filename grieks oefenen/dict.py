...
griekseWoordentekst18 = {
    ...
    "παρεσκεύασα": "aor van klaarmaken",
    ...
    "διέφθειρα": "aor van vernietigen, bederven",
    "ἀφεῖλον": "aor van wegnemen, afpakken",
    "ἀφαιρέω": "wegnemen, afpakken",
    "ἔβην": "aor van gaan, stappen",
    "ἔκλεψα": "aor van stelen",
    "κλέπτω": "stelen",
...
latijnseWoordentekst8 = {
    ...
    "fortasse": "misschien",
    "via": "weg, straat",
    "spectator, -oris": "toeschouwer",
    "curare": "verzorgen, zorgen voor",
    "quod": "omdat, (datgene) wat",
    "emere": "kopen",
    "pecunia": "geld",
    "poculum": "beker",
    "complēre": "vullen",
...
latijnseWoordentekst12 = {
    ...
    "veni":"pf van komen",
    "potui":"pf van kunnen",
    "tetigi":"pf van aanraken",
    "tangere":"aanraken",
    "iniuria":"onrecht",
    "feci":"pf van doen, maken",
    "risi":"pf van lachen",
...
latijnseWoordentekst13 = {
    "trans":"over, aan de overzijde van",
    "habitare":"(be)wonen",
    "quondam":"eens, ooit",
    "Romam":"naar Rome",
    "iter, itinera":"reis",
    "dedi":"pf van geven",
    "apud":"bij",
    "ostendi":"pf van tonen, laten zien",
    "domus":"huis",
    "hospes, hospites":"gast",
    "posui":"pf van plaatsen",
    ...
    "vixi":"pf van leven",
    "exemplum":"voorbeeld",
    "cucurri":"pf van rennen",
    "dominus":"meester, heer des huizes",
    "sustuli":"pf van optillen",
    "senex, senes":"oude man",
    "capere, capio":"pakken, nemen",
    "fugi":"pf van vluchten, ontvluchten",
    "fabula":"verhaal",
    "credere":"geloven",
}

latijnseWoordentekst15 = {
    "matrona":"matrona, vrouw des huizes",
    "meus, -a, -um":"mijn, van mij",
    "novus, -a, -um":"nieuw",
    "tuus, -a, -um":"nieuw",
    "vester, -stra, -strum":"jullie, van jullie",
    "laetus, -a, -um":"blij",
    "contentus, -a, -um":"tevreden (met)",
    "multus, -a, -um":"veel",
    "longus, -a, -um":"lang",
    "noster, -stra, -strum":"ons, onze",
    "parvus, -a, -um":"klein",
    "maritus":"echtgenoot",
    "liberi":"kinderen",
    "tempus, tempora":"tijd, periode",
    "suus, -a, -um":"zijn, haar, hun",
    "bonus, -a, -um":"goed",
    "magnus, -a, -um":"groot",
    "pulcher, -chra, -chrum":"mooi",
    "miser, -sera, -serum":"ongelukkig",
    "mors, mortes":"dood",
    "amisi":"pf van verliezen",
    "amittere":"verliezen",
    "amor, amores":"liefde",
    "unus, -a, -um":"een",
