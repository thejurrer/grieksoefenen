...
griekseWoordentekst7 = {
    ...
    "χαίρω": "blij zijn",
    "τὸ δῶρον": "geschenk",
    "ὡς ταχιστα":"zo snel mogelijk, zodra",
    "ἡ βοήθεια": "hulp"
}
...
griekseWoordentekst13 = {
    "ἀπεθανον": "aor van sterven, omkomen",
    "ἀποθνῄσκω": "sterven, omkomen",
    "ἀποκτείνω": "doden",
    "βάλλω": "gooien",
    "ἔβαλον": "aor van gooien",
    "ἔδραμον": "aor van rennen",
    "ἔλιπον": "aor van verlaten, achterlaten",
    "ἐλπίζω": "hopen (op), verwachten",
    "ἔμαθον": "aor van leren (kennen), vernemen",
